...
header-includes:
  - \usepackage[german, english]{babel} #rechtschreibung
  - \usepackage[utf8]{inputenc} # accepts more input
  - \usepackage[T1]{fontenc} #encodes font
  - \usepackage{lmodern} #verändert schriftart
  - \usepackage[onehalfspacing]{setspace} #1.5 Spacing
  - \usepackage[left=25mm,right=30mm,top=15mm,bottom=20mm]{geometry} #Seitenränder
  ...
  - \usepackage[backend=biber, style=authoryear, giveninits=true, maxbibnames=99, uniquename=init, maxcitenames=2, hyperref=true, date=year]{biblatex} #citation
  - \usepackage{xpatch} #patch commands
  - \usepackage{csquotes} #helps with multiple languages
  - \usepackage{amsmath} #matheumgebung
  - \usepackage{listings} #use programming code
...
## Brainarray and loading the Chip Describtion Files of mouse and bovine 
