...
```{r,echo=FALSE, out.height="25%", fig.cap="Density function of log intensity before and after normalization"}
...
```{r, echo=FALSE, out.height="25%", fig.cap= "Gene expression of mouse embryonic development before and after normalization"}
...
```{r, echo=FALSE, out.height="25%", fig.cap= "Gene expression bovine embryonic development before and after nromalization"}
## Before normalization
par (las =2)
...
```{r, echo=FALSE, out.height="25%", fig.cap= "Density function of bovine before and after normalization>"}
## Before normalization
...
```{r, echo=FALSE, out.height="25%", fig.cap="Scree plot and PCA of mouse data"}
...
EnhancedVolcano(Volcano.m, x = "logFC", y ="adj.P.Val", lab = Volcano.m$gene_symbols, title = "Volcano plot of mouse data", ylim = c(0,10), xlim= c(-4.5, 4.5))
...
```{r, echo=FALSE, fig.cap= "Gene expression in different cell stages mouse"}
par(mfrow= c(1,3))
...
```{r, echo=FALSE, out.height="40%", fig.cap= "Tissues with most overexpressed TRAs in four to eight cell stage"}
...
```{r, echo=FALSE, fig.width= 6, fig.height= 3, fig.cap= "Boxplot and VENN diagram of heart TRAs in mouse"}
...
After performing the DGE with our data set, we choose the Volcano Plot to present our results. The red dots are marking the significantly over or under expressed genes. We could only find 14 significantly differentially over or under expressed genes.
\begin{center}
```{r, echo=FALSE, fig.height= 4, fig.width= 4, fig.cap= "Volcano plot of bovine data"}
...
```{r, echo=FALSE, out.height="25%", fig.cap= "GSEA of mouse and bovine"}
