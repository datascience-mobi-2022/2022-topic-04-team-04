...
```{r, echo=FALSE, out.height="30%", fig.cap= "Tissues with most overexpressed TRAs in four to eight cell stage"}
...
```{r, echo=FALSE, out.height="20%", fig.cap= "GSEA of mouse and bovine"}
