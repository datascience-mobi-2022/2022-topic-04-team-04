...
#Results 
## VSN 
After the QC, we proceeded to normalize our data using the variance stabilization method. To see if the VSN was successful we used to plotting techniques, the mean versus standard deviation plot and the density probability.
