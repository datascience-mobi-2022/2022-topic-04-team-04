...
3.3.1 Volcano Plot
```{r}
png("volcano_mouse.png", height= 800, width= 800)
Volcano.m = readRDS(paste(projectPath,"Sessions","RDS_Files",'filtered_dge_mapped_df.rds',sep= "/"))
EnhancedVolcano(Volcano.m, x = "logFC", y ="adj.P.Val", lab = Volcano.m$gene_symbols,
...
```{r}
png("threebarplotsdge.png", height = 600, width = 800)
par(mfrow= c(1,3))
...
```{r}
png("volcano_bovine.png", height=800,width=800)
